...
window.Vue = (vue_dist_vue__WEBPACK_IMPORTED_MODULE_4___default());
vue_dist_vue__WEBPACK_IMPORTED_MODULE_4___default().use(Object(function webpackMissingModule() { var e = new Error("Cannot find module 'vue-router'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
vue_dist_vue__WEBPACK_IMPORTED_MODULE_4___default().use(Object(function webpackMissingModule() { var e = new Error("Cannot find module 'vue-axios'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()), (axios__WEBPACK_IMPORTED_MODULE_2___default()));
